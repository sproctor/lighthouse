...
/**
 * Icon to depict device in a control point UI. Is allowed to have a different value depending on
 * language requested (see ACCEPT-LANGUAGE and CONTENT-LANGUAGE header fields). Icon sizes to
 * support are vendor-specific. Contains the following sub elements:
 *
...
data class MediaIcon(
    @XmlElement(true) val mimetype: String,
    @XmlElement(true) val width: Int,
    @XmlElement(true) val height: Int,
    @XmlElement(true) val depth: Int,
